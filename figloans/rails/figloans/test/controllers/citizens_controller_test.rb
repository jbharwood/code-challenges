...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizen" do
    assert_difference('Citizen.count') do
      post citizens_url, params: { citizen: { address: @citizen.address, first_name: @citizen.first_name, last_name: @citizen.last_name, username: @citizen.username } }
    end
  ...
  test "should update citizen" do
    patch citizen_url(@citizen), params: { citizen: { address: @citizen.address, first_name: @citizen.first_name, last_name: @citizen.last_name, username: @citizen.username } }
